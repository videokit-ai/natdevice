...
namespace NatML.Devices.Outputs {
    ...
    /// </summary>
    public sealed class RenderTextureOutput : IDisposable {
        ...
        public static implicit operator Action<CameraImage> (RenderTextureOutput output) => image => output.Update(image);
        #endregion
    }
}