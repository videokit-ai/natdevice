...
namespace NatML.Devices.Outputs {
    ...
    public sealed class RenderTextureOutput : CameraOutput {
        ...
        /// <summary>
        /// Texture timestamp.
        /// This is the timestamp of the latest camera image in the render texture.
        /// </summary>
        ...
        [Obsolete(@"Deprecated in NatDevice 1.3.2. The output `texture` is now available immediately.", false)]
