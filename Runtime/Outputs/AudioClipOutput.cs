...
namespace NatML.Devices.Outputs {
    ...
    /// </summary>
    public sealed class AudioClipOutput : IDisposable {
        ...
        /// </summary>
        [MethodImpl(MethodImplOptions.Synchronized)]
        public void Dispose () => audioBuffer.Dispose();
        ...
        public static implicit operator Action<AudioBuffer> (AudioClipOutput output) => output.Update;
        #endregion
    }
}