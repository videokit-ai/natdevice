...
namespace NatML.Devices.Outputs {
    ...
    public sealed class PixelBufferOutput : IDisposable {
        ...
        public unsafe void Update (CameraImage image, ConversionOptions options = null) {
            // Create
        ...
        public static implicit operator Action<CameraImage> (PixelBufferOutput output) => image => output.Update(image);
        #endregion
    }
}