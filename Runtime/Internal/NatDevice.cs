...
namespace NatML.Devices.Internal {
    ...
    public static class NatDevice { // NatDevice.h
        ...
        public static extern void ReleaseSampleBuffer (this IntPtr sampleBuffet);
        ...
        public static extern void SetVideoStabilizationMode (this IntPtr device, CameraDevice.VideoStabilizationMode mode);
