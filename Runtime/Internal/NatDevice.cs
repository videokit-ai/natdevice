...
namespace NatML.Devices.Internal {
    ...
    public static class NatDevice { // NatDevice.h
        ...
        #region --NatML--
        [DllImport(Assembly, EntryPoint = @"NDSetAppToken")]
        ...
        public static extern void ReleaseDevice (this IntPtr device);
        [DllImport(Assembly, EntryPoint = @"NDReleaseSampleBuffer")]
        public static extern void ReleaseSampleBuffer (this IntPtr sampleBuffer);
        ...
        public static extern void StartRunning (
            this IntPtr device,
        ...
        public static extern void SetDisconnectHandler (
            this IntPtr device,
        ...
        public static extern Status AudioDevices (
            [Out] IntPtr[] devices,
            ref int size
        );
        ...
        public static extern Status CameraDevices (
            [Out] IntPtr[] devices,
            ref int size
        );
        ...
        public static void CheckStatus (this NatDevice.Status status) {
            switch (status) {
                ...
                case Status.MissingAppToken:    throw new InvalidOperationException(@"NatDevice app token has not been set. Check your NatML access key in 'Project Settings > NatML'");
                case Status.InvalidAppToken:    throw new InvalidOperationException(@"NatDevice app token is invalid. Check your NatML access key and plan.");
