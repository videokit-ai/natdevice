...
namespace NatML.Devices {
    ...
    public readonly partial struct CameraImage {
        ...
        public unsafe readonly float? exposureBias {
            get {
                var result = 0f;
                return image.CameraImageMetadata(MetadataKey.ExposureBias, &result) ? result : null;
            }
        }
        ...
        public unsafe readonly float? exposureDuration {
            get {
                var result = 0f;
                return image.CameraImageMetadata(MetadataKey.ExposureDuration, &result) ? result : null;
            }
        }
        ...
        public unsafe readonly float? ISO {
            get {
                var result = 0f;
                return image.CameraImageMetadata(MetadataKey.ISO, &result) ? result : null;
            }
        }
        ...
        public unsafe readonly float? focalLength {
            get {
                var result = 0f;
                return image.CameraImageMetadata(MetadataKey.FocalLength, &result) ? result : null;
            }
        }
        ...
        public unsafe readonly float? fNumber {
            get {
                var result = 0f;
                return image.CameraImageMetadata(MetadataKey.FNumber, &result) ? result : null;
            }
        }
        ...
        public unsafe readonly float? brightness {
            get {
                var result = 0f;
                return image.CameraImageMetadata(MetadataKey.Brightness, &result) ? result : null;;
            }
        }
        #endregion
