...
/*!
 ...
 @param devices
 Array populated with camera devices. Can be `NULL`.

 @param size
 Array size. On return, this will contain the current count of devices in the array.
 If `devices` is `NULL`, this will contain the total number of available audio devices on return.
*/
BRIDGE EXPORT void APIENTRY NDGetCameraDevices (
