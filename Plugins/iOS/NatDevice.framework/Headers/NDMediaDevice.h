...
/*!
 ...
 Media device.
*/
NML_BRIDGE NML_EXPORT void NML_API NDReleaseMediaDevice (NDMediaDevice* mediaDevice);
...
*/
NML_BRIDGE NML_EXPORT void NML_API NDMediaDeviceGetUniqueID (
...
/*!
 ...
 Destination UTF-8 string.
 */
NML_BRIDGE NML_EXPORT void NML_API NDMediaDeviceGetName (
    NDMediaDevice* mediaDevice,
    char* destination
);
...
*/
NML_BRIDGE NML_EXPORT NDDeviceFlags NML_API NDMediaDeviceGetFlags (NDMediaDevice* mediaDevice);
 ...
 */
NML_BRIDGE NML_EXPORT void NML_API NDMediaDeviceSetDisconnectHandler (
    NDMediaDevice* mediaDevice,
